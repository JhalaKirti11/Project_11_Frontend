            ...
            <Container sx={{ width: '65%', m: 0, paddingRight: 0, paddingLeft: 0 }}>
                {userChat._id ? (
                    <Box sx={{ flexGrow: 1, mr: 3, my: 2, p: 0 }}>
                        ...
                        <Card sx={{
                            height: '74vh', overflow: 'auto', borderBottom: 0, borderRadius: 0, backgroundImage: `linear-gradient(rgba(255,255,255,0.8), rgba(255,255,255,0.9)), url(../assets/emojiBackground.jpg)`,
